...
// La plataforma RedHumedal es ahora la RAÍZ de este mismo deploy. Este monitoreo
// vive en /herramientas/laguna-los-patos/monitoreo-nivel/ y vuelve al hub con una
// ruta absoluta desde el origen (mismo sitio en local y en producción).
var PLATAFORMA_URL = '';   // + '/humedal.html?...'  →  /humedal.html?...
